...
import homepage from "../../public/images/projects/Home_page.png";
...
const FeaturedProject = ({ type, title, summary, img, github, link }) => {
  return (
    <article className="dark:bg-dark dark:border-light w-full flex relative items-center justify-between rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 rounded-br-2xl lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4">
      <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2.5rem] bg-dark rounded-br-3xl dark:bg-primaryDark xs:-right-3 sm:h-[102%] xs:w-[100%] xs:rounded-[1.5rem]" />
    ...
    <>
      <article className=" dark:bg-dark dark:border-light w-full flex relative shadow-2xl items-center flex-col justify-center rounded-2xl border border-solid border-dark bg-light p-6 xs:p-4">
        ...
        <div className="w-full flex flex-col items-start justify-between mt-4">
          ...
          >
            <h2 className="my-2 w-full dark:text-light text-left text-3xl font-bold lg:text-2xl">
              {title}
            </h2>
          </Link>
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:ga[-y-24 sm:gap-x-0">
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                img={omni}
                summary=""
                link="https://omnifood4.netlify.app/"
                type="Frontend Project"
                github="https://github.com/delta1318/Omnifood"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                img={dog}
                summary=""
                link="https://tindog4.netlify.app/"
                type="Frontend Project"
                github="https://github.com/delta1318/Tindog"
              />
            </div>
          </div>
        </Layout>
